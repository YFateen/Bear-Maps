...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    ArrayList<Long> connectionsList = new ArrayList<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            Vertex v = new Vertex((long) Double.parseDouble(attributes.getValue("id"))
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            connectionsList.add((long) Double.parseDouble(attributes.getValue("ref")));
